...
public class Source extends TableImpl<SourceRecord> {
    ...
    /**
     * The column <code>public.source.organization</code>.
     */
    public final TableField<SourceRecord, String> ORGANIZATION = createField(DSL.name("organization"), SQLDataType.CLOB, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Integer, ? super String, ? super String, ? super String, ? super SourceType, ? super String, ? extends U> from) {
     ...
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Integer, ? super String, ? super String, ? super String, ? super SourceType, ? super String, ? extends U> from) {
